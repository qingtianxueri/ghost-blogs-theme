! function(modules) {
    ...
    ! function() {
        ...
        }), "undefined" != typeof title_home && $("#title-home").html(title_home), $document.on("ready", function() {
    ...
    var _createClass = function() {
        ...
        mapacheRelated = function() {
            function mapacheRelated(elem, pageUrl) {
                _classCallCheck(this, mapacheRelated), this.elem = elem, this.postID = elem.attr("mapache-post-id"), this.postTotal = elem.attr("mapache-post-total"), this.postTags = elem.attr("mapache-tag"), this.urlApi = ghost.url.api("posts", {
                    include: "tags"
                }), this.count = 0, this.pageUrl = pageUrl
            }
